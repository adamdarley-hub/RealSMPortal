...
export const getSupabaseJobs: RequestHandler = async (req, res) => {
  try {
    ...
    console.log(
      "❌ ERROR: Should not reach this point - force mode should have returned mock data!",
    );
    ...
    console.log(
      `⚡ Served ${result.jobs.length} jobs from Supabase in ${duration}ms`,
    );
...
export const getSupabaseClients: RequestHandler = async (req, res) => {
  try {
    ...
    console.log(
      `⚡ Served ${clients.length} clients from Supabase in ${duration}ms`,
    );
...
export const getSupabaseServers: RequestHandler = async (req, res) => {
  try {
    ...
    console.log(
      `⚡ Served ${servers.length} servers from Supabase in ${duration}ms`,
    );
