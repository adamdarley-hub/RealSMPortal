  ...
  try {
    ...
    if (req.method === "GET") {
      ...
      const globalCheck = {
        ...
        globalConfigKeys: global.tempApiConfig ? Object.keys(global.tempApiConfig) : [],
      ...
      if (baseUrl && apiKey) {
        try {
          ...
          console.log("📡 VERCEL DEBUG - ServeManager test result:", serveManagerTest);
        } catch (error) {
          serveManagerTest = {
            error: error instanceof Error ? error.message : 'Unknown error'
          };
          console.log("❌ VERCEL DEBUG - ServeManager test failed:", serveManagerTest);
        }
      } else {
